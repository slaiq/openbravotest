...
public abstract class UIDefinition {
  ...
  public String getGridFieldProperties(Field field) {
    ...
    try {
      gridProperties = WeldUtils.getInstanceFromStaticBeanManager(GridPropertiesHookCaller.class)
          .executeHook(new DalConnectionProvider(false), field);
      if (gridProperties != null) {
        result.append(gridProperties);
      }
    } catch (Exception e) {
  ...
  protected String getValueInComboReference(Field field, boolean getValueFromSession,
    ...
    try {
      ...
      String orgList = sa.elm.ob.utility.util.Utility.getOrgTypeOrganizationList(vars);
