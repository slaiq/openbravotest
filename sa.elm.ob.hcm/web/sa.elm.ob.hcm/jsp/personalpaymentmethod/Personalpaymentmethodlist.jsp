...
<BODY onresize="onResizeDo();" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" id="paramBody">
    <FORM id="form" method="post" action="" name="frmMain">
        ...
        <INPUT type="hidden" name="inpAction" id="inpAction" value=""></INPUT>
          ...
          <INPUT type="hidden" id="inpehcmPersonalPaymethdId" name="inpehcmPersonalPaymethdId" value="<%= request.getAttribute("inpehcmPersonalPaymethdId") %>"></INPUT>
                ...
                <TD valign="top">
                    ...
                    <DIV class="Main_ContentPane_ToolBar" id="paramToolBar">
                        <table class="Main_ContentPane_ToolBar Main_ToolBar_bg" id="tdToolBar">
                            ...
                            <td width="2%" ><a href="javascript:void(0);" onClick="onClickNew();" class="Main_ToolBar_Button" onMouseOver="window.status='Create a New Record';return true;" onMouseOut="window.status='';return true;" onclick="this.hideFocus=true" onblur="this.hideFocus=false" id="buttonNew"><img class="Main_ToolBar_Button_Icon Main_ToolBar_Button_Icon_New" src="../web/images/blank.gif" title="<%= Resource.getProperty("construction.new",lang)%>" border="0" id="linkButtonNew"></a></td>
                         <!--    <td class="Main_ToolBar_Separator_cell" ><img src="../web/images/blank.gif" class="Main_ToolBar_Separator"></img></td>
                            <td width="2%" ><a href="javascript:void(0);" onClick="onClickSave();" class="Main_ToolBar_Button_disabled" onMouseOver="window.status='Save Record';return true;" onMouseOut="window.status='';return true;" id="buttonSave"><img class="Main_ToolBar_Button_Icon Main_ToolBar_Button_Icon_Save_disabled" src="../web/images/blank.gif" title="<%= Resource.getProperty("construction.save", lang)  %>" border="0" id="linkButtonSave"></a></td>  -->
                                                       ...
                                                       <TD class="TextBox_ContentCell">
                                                           ...
                                                           <input type="hidden" name="inpHidEmpNo" id="inpHidEmpNo" value="<%= Utility.escapeQuote(request.getAttribute("inpEmpNo")) %>"></input>
                                                                   ...
                                                                   <div style="color:#000000;font-family: sans-serif;font-size:14px;margin-top:10px;text-align: center;"><%= Resource.getProperty("hcm.loading", lang)%>... </div>
                                                                         ...
                                                                         <div align="center">
                                                                         <table id="PaymentMethodList" class="scroll" cellpadding="0" cellspacing="0" width="100%">
                                                                         </table>
...
<script type="text/javascript">
var currentTab="PERPAYMETHOD",currentWindow='EMP';
var changesFlag =0,contextPath="<%=request.getContextPath()%>";
var PaymentMethodListGrid = jQuery("#PaymentMethodList");
...
var confirmdelete='<%= Resource.getProperty("hcm.confirmdelete", lang) %>';
...
<script type="text/javascript" src="../web/sa.elm.ob.hcm/js/PersonalPaymentMethodList.js"></script>
