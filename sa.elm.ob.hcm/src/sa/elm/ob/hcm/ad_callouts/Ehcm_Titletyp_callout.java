...
public class Ehcm_Titletyp_callout extends SimpleCallout {

  /**
   * Callout to fill end date as today when title type is inactive
   */
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    try {
      ...
      log4j.error("Exception in Title Type Active Callout :", e);
