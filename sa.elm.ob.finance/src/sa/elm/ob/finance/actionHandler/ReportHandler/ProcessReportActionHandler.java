...
import org.openbravo.client.application.report.ReportSemaphoreHandling;
 ...
 *
 */
public class ProcessReportActionHandler extends BaseProcessActionHandler {
  private static final Logger log = LoggerFactory.getLogger(ProcessReportActionHandler.class);
  ...
  private void doGenerateReport(JSONObject result, Map<String, Object> parameters,
    ...
    String strFileName = getSafeFilename(getPDFFileName(report, parameters, expType, params)+ "." + expType.getExtension());
  ...
  protected String getPDFFileName(ReportDefinition report, Map<String, Object> parameters,
    ...
    return report.getProcessDefintion().getName() + "-"
