package sa.elm.ob.finance.ad_reports.InvoiceReport;
...
public class NumberToArabic {
  ...
  private static String[] englishGroup = new String[] { "Hundred", "Thousand", "Million",
      "Billion", "Trillion", "Quadrillion", "Quintillion", "Sextillian", "Septillion", "Octillion",
  ...
  private static String[] arabicOnes = new String[] { "", "واحد", "اثنان", "ثلاثة", "أربعة",
      "خمسة", "ستة", "سبعة", "ثمانية", "تسعة", "عشرة", "أحد عشر", "اثنا عشر", "ثلاثة عشر",
  ...
  private static String[] arabicFeminineOnes = new String[] { "", "إحدى", "اثنتان", "ثلاث", "أربع",
      "خمس", "ست", "سبع", "ثمان", "تسع", "عشر", "إحدى عشرة", "اثنتا عشرة", "ثلاث عشرة",
  ...
  private static String processGroup(int groupNumber) {
    ...
    if (tens > 0) {
      if (tens < 20) {
        retVal += ((StringUtils.isNotEmpty(retVal)) ? " " : "") + englishOnes[tens];
      } else {
        int ones = tens % 10;

        tens = (tens / 10) - 2; // 20's offset

        retVal += ((StringUtils.isNotEmpty(retVal)) ? " " : "") + englishTens[tens];

        if (ones > 0) {
          // retVal += ((retVal != "") ? " " : "") + englishOnes[ones];
          retVal += ((StringUtils.isNotEmpty(retVal)) ? " " : "") + englishOnes[ones];
        }
      }
    }
  ...
  public static String convertToEnglish() {
    ...
    formattedNumber += (retVal != "") ? (_intergerValue == 1 ? currencyInfo.englishCurrencyName
