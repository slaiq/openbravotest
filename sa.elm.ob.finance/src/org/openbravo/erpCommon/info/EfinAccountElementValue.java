...
public class EfinAccountElementValue extends HttpSecureAppServlet {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      if (strAcctSchema.equals("")) {
        strAcctSchema = vars.getRequestGlobalVariable("inpcAcctSchemaId",
            "EfinAccountElementValue.cAcctschemaId");
      }
      if (strAcctSchema.equals("")) {
        strAcctSchema = Utility.getContext(this, vars, "$C_AcctSchema_ID",
            "EfinAccountElementValue");
        vars.setSessionValue("EfinAccountElementValue.cAcctschemaId", strAcctSchema);
      } else
        vars.setSessionValue("$C_AcctSchema_ID", strAcctSchema);

      vars.removeSessionValue("EfinAccountElementValue.value");
      if (!strNameValue.equals(""))
        vars.setSessionValue("EfinAccountElementValue.name", strNameValue + "%");

      String strValue = vars.getGlobalVariable("inpValue", "EfinAccountElementValue.value", "");
      String strName = vars.getGlobalVariable("inpName", "EfinAccountElementValue.name", "");
      ...
      vars.removeSessionValue("EfinAccountElementValue.name");
      vars.setSessionValue("EfinAccountElementValue.value", strKeyValue + "%");
      String strOrg = vars.getStringParameter("inpAD_Org_ID");
      EfinAccountElementValueData[] data = EfinAccountElementValueData.selectKey(this,
          strAcctSchema, Utility.getContext(this, vars, "#User_Client", "EfinAccountElementValue"),
          Utility.getSelectorOrgs(this, vars, strOrg), vars.getRole(), strKeyValue + "%");
  ...
  private void printPageKey(HttpServletResponse response, VariablesSecureApp vars,
      EfinAccountElementValueData[] data) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
      log4j.debug("Output: EfinAccountElementValue seeker Frame Set");
  ...
  private String generateResult(EfinAccountElementValueData[] data)
      throws IOException, ServletException {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strValue,
    ...
    XmlDocument xmlDocument = xmlEngine
        .readXmlTemplate("org/openbravo/erpCommon/info/EfinAccountElementValue")
        .createXmlDocument();
    EfinAccountElementValueData[] data = null;
    if (isDefault) {
      if (strValue.equals("") && strName.equals(""))
        strValue = "%";
      data = EfinAccountElementValueData.set(strValue, strName);
    } else {
      data = EfinAccountElementValueData.select(this, "1", "", "", "", "", strElementValue,
          Utility.getContext(this, vars, "#User_Client", "EfinAccountElementValue"),
          Utility.getContext(this, vars, "#User_Org", "EfinAccountElementValue"), vars.getRole(),
          "1 ASC", "", "");
    }
    ...
    try {
      ...
      // accesslevel)
      EfinAccountElementValueData[] dataOrg = null;
      dataOrg = EfinAccountElementValueData.selectOrgValidation(this,
      ...
      ComboTableData comboTableData = new ComboTableData(vars, this, "19", "AD_Org_ID", "", "",
          orgList, Utility.getContext(this, vars, "#User_Client", "EfinAccountElementValue"), 0);
      Utility.fillSQLParameters(this, vars, null, comboTableData, "EfinAccountElementValue", "");
    ...
    if ("".equals(strAcctSchema))
      ...
      xmlDocument.setParameter("inpcAcctSchema",
          EfinAccountElementValueData.selectschemaname(this, strAcctSchema));
  ...
  private void printGridStructure(HttpServletResponse response, VariablesSecureApp vars)
    ...
    XmlDocument xmlDocument = xmlEngine
        .readXmlTemplate("org/openbravo/erpCommon/utility/DataGridStructure").createXmlDocument();
    ...
    if (headers != null) {
      try {
        ...
        if (strNewFilter.equals("1") || strNewFilter.equals("")) { // New
          ...
          strNumRows = EfinAccountElementValueData.countRows(this, rownum, strAcctSchema, strValue,
              strName, strOrganization, strAccountElementValue,
              Utility.getContext(this, vars, "#User_Client", "EfinAccountElementValue"),
              Utility.getContext(this, vars, "#AccessibleOrgTree", "EfinAccountElementValue"),
              vars.getRole(), pgLimit, oraLimit1, oraLimit2);
        ...
        if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
          ...
          data = EfinAccountElementValueData.select(this, "ROWNUM", strAcctSchema, strValue,
              strName, strOrganization, strAccountElementValue,
              Utility.getContext(this, vars, "#User_Client", "EfinAccountElementValue"),
              Utility.getContext(this, vars, "#AccessibleOrgTree", "EfinAccountElementValue"),
              vars.getRole(), strOrderBy, oraLimit, "");
        } else {
          String pgLimit = pageSize + " OFFSET " + offset;
          data = EfinAccountElementValueData.select(this, "1", strAcctSchema, strValue, strName,
              strOrganization, strAccountElementValue,
              Utility.getContext(this, vars, "#User_Client", "EfinAccountElementValue"),
              Utility.getContext(this, vars, "#AccessibleOrgTree", "EfinAccountElementValue"),
              vars.getRole(), strOrderBy, "", pgLimit);
        }
