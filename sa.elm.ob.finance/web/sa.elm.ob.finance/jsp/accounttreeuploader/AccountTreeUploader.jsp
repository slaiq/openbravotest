...
<HEAD>
 <META http-equiv="Content-Type" content="text/html; charset=utf-8"></META>
    <TITLE><%=Resource.getProperty("finance.accounttree.upload.title",lang)%></TITLE>
...
<FORM name="frmMain" method="post" action="" enctype="multipart/form-data" id="SubContractForm">
  ...
  <INPUT type="hidden" name="inpcElementId" id="inpcElementId" value="${requestScope.inpcElementId}"></INPUT>
    ...
    <TD>
      <TABLE cellspacing="0" cellpadding="0" class="Popup_ContentPane_NavBar" id="tdToolBar">
        <TR class="Popup_NavBar_bg"><TD></TD>
          ...
          <TD class="Popup_NavBar_Popup_title_cell"><SPAN><%=Resource.getProperty("finance.accounttree.upload.title",lang)%></SPAN></TD>
          <TD class="Popup_NavBar_separator_cell"></TD>
        </TR>
      </TABLE>
    </TD>
     ...
     <table cellspacing="0" cellpadding="0" class="Popup_ContentPane_InfoBar">
        <tbody><tr>
          ...
          <td class="Popup_InfoBar_text_table">
            <table>
              <tbody><tr>
                <td class="Popup_InfoBar_text" id="processHelp"><%=Resource.getProperty("finance.accounttree.upload.title",lang)%> </td>
              </tr>
            </tbody></table>
          </td>
        </tr>
...
function validateFile() {   
    ...
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.finance.ad_process.accounttreeuploader.header/AccountTreeUploader?inpAction=validate&inpcElementId="+document.getElementById("inpcElementId").value;
...
function uploadCSV() {
    ...
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.finance.ad_process.accounttreeuploader.header/AccountTreeUploader?inpAction=upload&inpcElementId="+document.getElementById("inpcElementId").value;    
    document.forms['frmMain'].submit();
}

function closePopUp() {
    document.frmMain.action="<%=request.getContextPath()%>/sa.elm.ob.finance.ad_process.accounttreeuploader.header/AccountTreeUploader?inpAction=Close&pageType="+"<%= request.getAttribute("pageType") %>";
