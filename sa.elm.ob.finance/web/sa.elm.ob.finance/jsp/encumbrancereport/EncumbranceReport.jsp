...
<HTML xmlns="http://www.w3.org/1999/xhtml">
    ...
    <TITLE><%= Resource.getProperty("finance.encumbrance.report",lang) %></TITLE>
        ...
        <script type="text/javascript" src="../web/js/appStatus.js"></script>     
        <style type="text/css">
    ...
    <BODY onresize="onResizeDo();" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" id="paramBody">
        <FORM id="form" method="post" action="" name="frmMain">
            ...
            <INPUT type="hidden" name="inpfinReconciliationId" id="inpfinReconciliationId" value="${requestScope.inpfinReconciliationId}"></INPUT>
                                        ...
                                        <div>
                                            <span class="dojoTabcurrentfirst">
                                                <div>
                                                    ...
                                                    <%= Resource.getProperty("finance.encumbrance.report",lang).replace("'", "\\\'") %>
                                                    </a></span>
                                                </div>
                                            </span>
                                        </div>
    ...
    {
        submitCommandForm('DEFAULT', false, null, 'EncumbranceReport', '_self', null, false); 
        return false;
    }
