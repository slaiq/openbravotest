...
<HEAD>
<TITLE><%= Resource.getProperty("finance.insufficientfundsanalysis.title",lang) %></TITLE>
                              ...
                              <div>
                                 <span class="dojoTabcurrentfirst">
                                    <div>
                                       ...
                                       <%= Resource.getProperty("finance.insufficientfundsanalysis.title",lang).replace("'", "\\\'") %>
                                       </a></span>
                                    </div>
                                 </span>
                              </div>
                                    ...
                                    <TD>
                                       ...
                                       <TABLE  align="center" width="100%">
                                          ...
                                          <tr>
                                             ...
                                             <td class="TextBox_ContentCell">
                                                <select id="inpView" class="ComboKey Combo_TwoCells_width">
...
function reloadWindow() {
    submitCommandForm('DEFAULT', false, null, 'InsufficientFundsAnalysis', '_self', null, false);
    return false;
}
...
function generateReport() {
    ...
    openServletNewWindow('PRINT_PDF', true, null, 'InsufficientFundsAnalysis', null, false, '700', '1000', true);
    return false;
}
