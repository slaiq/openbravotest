...
<FORM name="frmMain" method="post" action="" enctype="multipart/form-data" id="SubContractForm">
  ...
  <INPUT type="hidden" name="inpFormID" id="inpFormID" value="<%=request.getAttribute("inpFormID")%>"></INPUT>
   <INPUT type="hidden" name="inpBudgetRevId" id="inpBudgetRevId" value="<%= request.getAttribute("inpBudgetRevId")%>"></INPUT>
...
function validateFile() {
    ...
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.finance.ad_process.ImportBudgetRevision.header/ImportBudgetRevision?action=validateCsv&inpBudgetRevId="+document.getElementById('inpBudgetRevId').value;
...
function uploadCSV() {
    ...
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.finance.ad_process.ImportBudgetRevision.header/ImportBudgetRevision?action=uploadCsv&inpBudgetRevId="+document.getElementById('inpBudgetRevId').value;
    document.forms['frmMain'].submit();
    
}
function closePopUp() {
    document.frmMain.action="<%=request.getContextPath()%>/sa.elm.ob.finance.ad_process.ImportBudgetRevision.header/ImportBudgetRevision?action=Close&pageType="+"<%= request.getAttribute("pageType") %>";
