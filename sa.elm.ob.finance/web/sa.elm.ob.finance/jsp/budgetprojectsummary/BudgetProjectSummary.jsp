...
<HEAD>
<TITLE><%= Resource.getProperty("finance.budgetprojsumm.title",lang) %></TITLE>
                              ...
                              <div>
                                 <span class="dojoTabcurrentfirst">
                                    <div>
                                       ...
                                       <%= Resource.getProperty("finance.budgetprojsumm.title",lang).replace("'", "\\\'") %>
                                       </a></span>
                                    </div>
                                 </span>
                              </div>
...
function reloadWindow() {
    submitCommandForm('DEFAULT', false, null, 'BudgetProjectSummary', '_self', null, false);
    return false;
}
...
function generateReport() {
    ...
    openServletNewWindow('PRINT_PDF', true, null, 'BudgetProjectSummary', null, false, '700', '1000', true);
    return false;
}
