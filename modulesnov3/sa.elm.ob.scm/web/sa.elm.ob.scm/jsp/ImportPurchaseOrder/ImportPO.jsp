...
<FORM name="frmMain" method="post" action="" enctype="multipart/form-data" id="SubContractForm">
  ...
  <INPUT type="hidden" name="inpOrderId" id="inpOrderId" value="<%= request.getAttribute("inpOrderId")%>"></INPUT>
     ...
     <table cellspacing="0" cellpadding="0" class="Popup_ContentPane_InfoBar">
        <tbody><tr>
          ...
          <td class="Popup_InfoBar_text_table">
            <table>
              <tbody><tr>
                <td class="Popup_InfoBar_text" id="processHelp"><%=Resource.getProperty("scm.import.purchaseorder.title",lang)%> </td>
              </tr>
            </tbody></table>
          </td>
        </tr>
...
function validateFile() {
    ...
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.scm.ad_process.ImportPurchaseOrder/ImportPOLines?action=validateCsv&inpOrderId="+document.getElementById('inpOrderId').value;
...
function uploadCSV() {
    ...
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.scm.ad_process.ImportPurchaseOrder/ImportPOLines?action=uploadCsv&inpOrderId="+document.getElementById('inpOrderId').value;
    document.forms['frmMain'].submit();
    
}

function closePopUp() {
    document.frmMain.action="<%=request.getContextPath()%>/sa.elm.ob.scm.ad_process.ImportPurchaseOrder/ImportPOLines?action=Close&pageType="+"<%= request.getAttribute("pageType") %>";
