  ...
  <span class="tabTitle">
    <div class="tabTitle_background">
      <span class="tabTitle_elements_container">
        <span class="tabTitle_elements_text" id="tabTitle_text"><%=Resource.getProperty("scm.custodyupload.title",lang)%></span>
   ...
   <div>
     <span class="dojoTabcurrentfirst">
        <div>
           ...
           <%=Resource.getProperty("scm.noncustodyupload.title",lang)%>
            </a></span>
         </div>
    </span>
   </div>
...
function validateFileExtension() {
    ...
    if (!(/\.(csv)$/i).test(file)) {
    	...
    	OBAlert('<%= Resource.getProperty("scm.cu.validcsvonly", lang) %>');
...
function validateFile() {
    if(validateFileExtension()==false)
        return false;
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.scm.ad_forms.NonCustodyUpload.header/NonCustodyUploadTemplate?action=validateCsv";
...
function uploadCSV() {
    ...
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.scm.ad_forms.NonCustodyUpload.header/NonCustodyUploadTemplate?action=uploadCsv";
    document.forms['frmMain'].submit();
