                              ...
                              <div>
                                 <span class="dojoTabcurrentfirst">
                                    <div>
                                       ...
                                       <%= Resource.getProperty("scm.returneditems.report",lang).replace("'", "\\\'") %>
                                       </a></span>
                                    </div>
                                 </span>
                              </div>
...
function reloadWindow() {
    submitCommandForm('DEFAULT', false, null, 'ReturnedItemsReport', '_self', null, false);
    return false;
}
...
function generateReport() {
    ...
    document.getElementById("inpAction").value = "Submit";
      ...
      openServletNewWindow('PRINT_PDF', true, null, 'ReturnedItemsReport', null, false, '700', '1000', true);
    return false;
}
$( "#inpWarehouseType").select2(selectBoxAjaxPaging({size: "med/popup",
    placeholder: true}));
   </script>
</HTML>