   ...
   <div>
     <span class="dojoTabcurrentfirst">
        <div>
           ...
           <%=Resource.getProperty("scm.custodyupload.title",lang)%>
            </a></span>
         </div>
    </span>
   </div>
...
function validateFile() {
    if(validateFileExtension()==false)
        return false;
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.scm.ad_forms.CustodyUpload.header/CustodyUploadTemplate?action=validateCsv";
...
function uploadCSV() {
    ...
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.scm.ad_forms.CustodyUpload.header/CustodyUploadTemplate?action=uploadCsv";
    document.forms['frmMain'].submit();
