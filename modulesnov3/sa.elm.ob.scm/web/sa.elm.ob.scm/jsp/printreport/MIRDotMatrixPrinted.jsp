                ...
                <td colspan="2"><table>
                 <tr>
                    <TD class="TextBox_btn_ContentCell TextBox_ReadOnly_ContentCell">
                         <p><%= request.getAttribute("username")%> already print this report at <%= request.getAttribute("printedDate")%></p>
                    </TD>
                </tr>
                <tr><td>&nbsp;</td></tr>
                </table>
...
$(document).ready(function(){
   var ordertype = "<%= request.getAttribute("Ordertype")%>";
    ...
    function GenerateReport(){
        $("#action").val("DownloadReportMIRPrinted");  


            
            submitCommandForm('DEFAULT', false, null, '<%=request.getContextPath()%>/sa.elm.ob.scm.ad_process.printreport/PrintReport?report=MIRDotMatrixPrinted', 'background_target', null, false);        
            closePage();
            return true;
