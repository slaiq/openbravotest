...
(function () {
  ...
  var buttonProps = {
    action: function () {
      ...
      var callback = function (ok) {
          ...
          if (ok) {
            ...
            OB.RemoteCallManager.call('sa.elm.ob.scm.actionHandler.UnApplyPOChanges', requestParams, {
              action: 'unapply'
            }, EscmApplyChange);
          }
          };
      isc.ask(OB.I18N.getLabel('ESCM_SureToUnApplyChanges'), callback);
    },
    ...
    buttonType: 'escm_unapply',
    prompt: OB.I18N.getLabel('ESCM_UnApplyChanges')
  };
