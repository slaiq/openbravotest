 ...
 * All Rights Reserved. 
 * Contributor(s):  ______Gopalakrishnan________________________________.
 ************************************************************************
 */
package sa.elm.ob.scm.ad_reference.productComplete;
...
public class ProductComplete extends HttpSecureAppServlet {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strKeyValue,
    ...
    XmlDocument xmlDocument = xmlEngine
        .readXmlTemplate("org/openbravo/erpCommon/info/ProductComplete").createXmlDocument();
  ...
  private void printGridData(HttpServletResponse response, VariablesSecureApp vars, String strKey,
    ...
    String strNewFilter = strnewFilter;
    if (headers != null) {
      try {
