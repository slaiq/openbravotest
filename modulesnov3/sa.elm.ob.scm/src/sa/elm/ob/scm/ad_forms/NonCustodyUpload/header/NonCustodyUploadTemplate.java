package sa.elm.ob.scm.ad_forms.NonCustodyUpload.header;
...
import sa.elm.ob.scm.ad_forms.NonCustodyUpload.dao.NonCustodyUploadTemplateDAO;

/**
 * @author Gopalakrishnan on 02/05/2017
 */
public class NonCustodyUploadTemplate extends HttpSecureAppServlet {

  /**
   * Servlet implementation class Non Custody Upload Template
   */
  private static final long serialVersionUID = 1L;

  // location to store file uploaded
  private static final String UPLOAD_DIRECTORY = "CustodyUpload";

  // upload settings
  private static final int MEMORY_THRESHOLD = 1024 * 1024 * 3; // 3MB
  private static final int MAX_FILE_SIZE = 1024 * 1024 * 40; // 40MB
  private static final int MAX_REQUEST_SIZE = 1024 * 1024 * 50; // 50MB
  private static final String includeIn = "../web/sa.elm.ob.scm/jsp/NonCustodyUpload/NonCustodyUpload.jsp";

  /**
   * @see HttpServlet#HttpServlet()
   */
  public NonCustodyUploadTemplate() {
    super();
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (inpAction.equals("uploadCsv") || inpAction.equals("validateCsv")) {
      ...
      NonCustodyUploadTemplateDAO dao = null;
      ...
      try {
        ...
        dao = new NonCustodyUploadTemplateDAO();
