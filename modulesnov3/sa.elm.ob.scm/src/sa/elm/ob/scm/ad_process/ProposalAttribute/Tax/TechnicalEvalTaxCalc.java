...
public class TechnicalEvalTaxCalc implements Process {

  private static final Logger log4j = Logger.getLogger(TechnicalEvalTaxCalc.class);
  ...
  public synchronized void execute(ProcessBundle bundle) throws Exception {
    try {
      ...
      TechnicalTaxCalculationDAOImpl dao = null;
      HttpServletRequest request = RequestContext.get().getRequest();
      VariablesSecureApp vars = new VariablesSecureApp(request);
      String proposalId = "";
      dao = new TechnicalTaxCalculationDAOImpl();
