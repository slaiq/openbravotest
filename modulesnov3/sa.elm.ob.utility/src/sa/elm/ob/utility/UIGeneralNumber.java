...
public class UIGeneralNumber extends UIReference {
  public UIGeneralNumber(String reference, String subreference) {
  ...
  public String formatGridValue(VariablesSecureApp vars, String value) {
    String rt = value;
    try {
      DecimalFormat numberFormat = Utility.getFormat(vars, "generalNumberRelation");
