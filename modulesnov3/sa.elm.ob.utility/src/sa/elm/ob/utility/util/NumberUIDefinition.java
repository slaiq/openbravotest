...
public abstract class NumberUIDefinition extends UIDefinition {
  ...
  private String getInputFormatters(FormatDefinition inputFormat) {
    final StringBuilder sb = new StringBuilder();
    sb.append(
        "parseInput: function(value, field, component, record) { if (field!==undefined && field.id!=='C7AAB2403DBD4D39B8DAC9C6CB99AA9C' && field.id!=='94FF7FCE400241CE828B63AAD670347E'){\n"
  ...
  private String getFormatter(FormatDefinition formatDefinition) {
    return "function(value, field, component, record) {if (field!==undefined && field.id!=='C7AAB2403DBD4D39B8DAC9C6CB99AA9C' && field.id!=='94FF7FCE400241CE828B63AAD670347E'){\n"
        + "return OB.Utilities.Number.JSToOBMasked(value," + "'" + formatDefinition.getFormat()
        + "'," + "'" + formatDefinition.getDecimalSymbol() + "'," + "'"
        + formatDefinition.getGroupingSymbol()
        + "', OB.Format.defaultGroupingSize);}else{\nreturn value;\n}}";
  }
  ...
  public static class GeneralNumberUIDefinition extends NumberUIDefinition {
    public String getParentType() {
      return "float";
    }

    public String getFormat() {
      return "generalNumberEdition";
    }
  }
