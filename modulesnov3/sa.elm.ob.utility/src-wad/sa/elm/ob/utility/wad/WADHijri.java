...
public class WADHijri extends WADControl {
  private WADControl button;

  public WADHijri() {
  }

  public WADHijri(Properties prop) {
    setInfo(prop);
    initialize();
  }
  ...
  private void generateJSCode() {
    addImport("z", "../../../../../web/js/jquery-1.11.0.min.js");
    addImport("n", "../../../../../web/sa.elm.ob.utility/js/jquery.min_1.11.0.js");
    addImport("z", "../../../../../web/sa.elm.ob.utility/js/jquery.plugin.js");
    addImport("x",
        "../../../../../web/sa.elm.ob.utility/js/jquery.calendars.package-2.0.2/jquery.calendars.js");
    addImport("w",
        "../../../../../web/sa.elm.ob.utility/js/jquery.calendars.package-2.0.2/jquery.calendars.ummalqura.js");
    addImport("v",
        "../../../../../web/sa.elm.ob.utility/js/jquery.calendars.package-2.0.2/jquery.calendars.ummalqura-ar.js");
    addImport("u",
        "../../../../../web/sa.elm.ob.utility/js/jquery.calendars.package-2.0.2/jquery.calendars.plus.js");
    addImport("t",
        "../../../../../web/sa.elm.ob.utility/js/jquery.calendars.package-2.0.2/jquery.calendars.picker.js");
    addImport("s",
        "../../../../../web/sa.elm.ob.utility/js/jquery.calendars.package-2.0.2/jquery.calendars.picker.ext.js");
    addImport("q", "../../../../../web/js/default/DateTextBox.js");
    addImport("p", "../../../../../web/js/jscalendar/calendar.js");
    addImport("o", "../../../../../web/js/jscalendar/lang/calendar-lang.js");
    addImport("y", "../../../../../web/sa.elm.ob.utility/js/UmmalQura.js");
    addCSSImport("e",
        "../../../../../web/sa.elm.ob.utility/js/jquery.calendars.package-2.0.2/jquery.calendars.picker.css");
    addJSCode("renderInputHijriDate", "$(document).ready(function() { renderInputHijriDate(); });");
    /*
     * addCSSImport("d",
     * "../../../../../web/sa.elm.ob.utility/js/jquery.calendars.package-2.0.2/smoothness.calendars.picker.css"
     * ); addCSSImport("c",
     * "../../../../../web/sa.elm.ob.utility/js/jquery.calendars.package-2.0.2/jquery-ui-smoothness.css"
     * ); addCSSImport("b",
     * "../../../../../web/sa.elm.ob.utility/js/jquery.calendars.package-2.0.2/ui-smoothness.calendars.picker.css"
     * );
     */
  ...
  private void generateValidation() {
    ...
    XmlDocument xmlDocument = getReportEngine()
        .readXmlTemplate("sa/elm/ob/utility/wad/WADHijriJSValidation", discard).createXmlDocument();
  ...
  public String editMode() {
    ...
    XmlDocument xmlDocument = getReportEngine()
        .readXmlTemplate("sa/elm/ob/utility/wad/WADHijri", discard).createXmlDocument();
  ...
  public String toXml() {
    ...
    if (getData("IsParameter").equals("Y"))
      discard[0] = "xx";
    XmlDocument xmlDocument = getReportEngine()
        .readXmlTemplate("sa/elm/ob/utility/wad/WADHijriXML", discard).createXmlDocument();
    xmlDocument.setParameter("columnName", getData("ColumnName"));
    return replaceHTML(xmlDocument.print());
  }
  ...
  public void processSelCol(String tableName, EditionFieldsData selCol,
      Vector<Object> vecAuxSelCol) {
