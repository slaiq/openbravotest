...
$.extend(Datepicker.prototype, {
	...
	_generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate,
		...
		if (secondary || !changeMonth)
			...
			monthHtml += '<select class="ui-datepicker-month Combo" style="height: 18px;" ' +
		...
		if (secondary || !changeYear)
			...
			inst.yearshtml += '<select class="ui-datepicker-year Combo" style="height: 18px;" ' +
			...
			if( ! $.browser.mozilla ){
				...
				html += '<select class="ui-datepicker-year Combo" style="height: 18px;"><option value="' + drawYear + '" selected="selected">' + drawYear + '</option></select>';
			}
		}
