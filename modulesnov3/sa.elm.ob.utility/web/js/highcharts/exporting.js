...
(function(f) {
  ...
  function h(c, C, f, n) {
    c.hasOwnProperty(C) || (c[C] = n.apply(null, f))
  }
  f = f ? f._modules : {};
  ...
  h(f, "modules/exporting.src.js", [f["parts/Globals.js"], f["mixins/navigation.js"]], function(c, f) {
    var h = c.defaultOptions,
      ...
      G = c.SVGRenderer,
      I = c.Renderer.prototype.symbols,
      K = /Edge\/|Trident\/|MSIE /.test(H),
      L = /firefox/i.test(H);
    y(h.lang, {
    ...
    y(A.prototype, {
      ...
      getSVG: function(b) {
        var a, u, d, f, m, k = p(this.options, b);
        u = r("div", null, {
          position: "absolute",
          top: "-9999em",
        ...
        d = k.exporting.sourceWidth || k.chart.width ||
          /px$/.test(d) && parseInt(d, 10) || (k.isGantt ? 800 : 600);
      ...
      getFilename: function() {
        ...
        if (a) return a;
        "string" === typeof b && (a = b.toLowerCase().replace(/<\/?[^>]+(>|$)/g, "").replace(/[\s_]+/g, "-").replace(/[^a-z0-9\-]/g, "").replace(/^[\-]+/g, "").replace(/[\-]+/g, "-").substr(0,
          24).replace(/[\-]+$/g, ""));
      ...
      contextMenu: function(b, a, u, d, f, m, k) {
        var e = this,
          ...
          B = Math.max(f, m),
          p;
        g || (e.exportContextMenu = e[h] = g = r("div", {
          className: b
        }, {
          position: "absolute",
          zIndex: 1E3,
          padding: B + "px",
          pointerEvents: "auto"
        }, e.fixedDiv || e.container), p = r("div", {
          className: "highcharts-menu"
        }, null, g), e.styledMode || w(p, y({
        ...
        }, e.exportEvents.push(v(g, "mouseleave", function() {
          g.hideTimer = setTimeout(g.hideMenu, 500)
        }), v(g, "mouseenter", function() {
          c.clearTimeout(g.hideTimer)
        }), v(n, "mouseup", function(a) {
          ...
          if (c.isObject(a, !0)) {
            var b;
            a.separator ? b = r("hr", null, null, p) : (b = r("div", {
              ...
              w(this, x.menuItemHoverStyle)
            }, b.onmouseout = function() {
              w(this, x.menuItemStyle)
            }, w(b, y({
              cursor: "pointer"
            }, x.menuItemStyle))));
            e.exportDivElements.push(b)
          }
        }), e.exportDivElements.push(p, g), e.exportMenuWidth = g.offsetWidth, e.exportMenuHeight = g.offsetHeight);
        a = {
          display: "block"
        };
        u + e.exportMenuWidth > l ? a.right = l - u - f - B + "px" : a.left = u - B + "px";
        d + m +
          e.exportMenuHeight > q && "top" !== k.alignOptions.verticalAlign ? a.bottom = q - d - B + "px" : a.top = d + m - B + "px";
        w(g, a);
        e.openMenu = !0
      },
      addButton: function(b) {
        var a = this,
          c = a.renderer,
          d = p(a.options.navigation.buttonOptions, b),
          f = d.onclick,
          m = d.menuItems,
          k, e, h = d.symbolSize || 12;
        ...
        if (!1 !== d.enabled) {
          var l = d.theme,
            ...
            q = q && q.select,
            g;
          a.styledMode || (l.fill = t(l.fill, "#ffffff"), l.stroke = t(l.stroke, "none"));
          delete l.states;
          f ? g = function(b) {
            b && b.stopPropagation();
            f.call(a, b)
          ...
          d.text && d.symbol ? l.paddingLeft = t(l.paddingLeft, 25) : d.text || y(l, {
            width: d.width,
            height: d.height,
            padding: 0
          });
          a.styledMode || (l["stroke-linecap"] = "round", l.fill = t(l.fill, "#ffffff"), l.stroke = t(l.stroke, "none"));
          e = c.button(d.text, 0, 0, g, l, n, q).addClass(b.className).attr({
            title: t(a.options.lang[d._titleKey || d.titleKey], "")
          });
    ...
    A.prototype.inlineStyles = function() {
      ...
      function a(c) {
        function u(a, g) {
          ...
          q || m[g] === a && "svg" !== c.nodeName || e[c.nodeName][g] === a || (-1 !== d.indexOf(g) ? c.setAttribute(b(g), a) : n += b(g) + ":" + a + ";")
        }
        var g, m, n = "",
          t, q, v, r;
        if (1 === c.nodeType && -1 === k.indexOf(c.nodeName)) {
          ...
          e[c.nodeName] || (x = l.getElementsByTagName("svg")[0],
            t = l.createElementNS(c.namespaceURI, c.nodeName), x.appendChild(t), e[c.nodeName] = p(z.getComputedStyle(t, null)), "text" === c.nodeName && delete e.text.fill, x.removeChild(t));
          if (L || K)
            for (var w in g) u(g[w], w);
          else F(g, u);
          n && (g = c.getAttribute("style"), c.setAttribute("style", (g ? g + ";" : "") + n));
    ...
    I.menuball = function(b, a, c, d) {
      b = [];
      d = d / 3 - 2;
      return b = b.concat(this.circle(c - d, a, d, d),
    ...
    A.prototype.renderExporting = function() {
      var b = this,
        ...
        c = a.buttons,
        d = b.isDirtyExporting || !b.exportSVGElements;
      b.buttonOffset = 0;
    ...
    v(A, "init", function() {
      ...
      b.exporting = {
        update: function(a, c) {
          ...
          p(!0, b.options.exporting, a);
          t(c, !0) && b.redraw()
        }
      };
      f.addUpdate(function(a, c) {
        b.isDirtyExporting = !0;
        p(!0, b.options.navigation, a);
        t(c, !0) && b.redraw()
      }, b)
    });
