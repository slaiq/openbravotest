<%@page import="com.qualiantech.utility.properties.Resource, org.apache.log4j.Logger" isErrorPage="true" contentType="text/html"%>
<%
...
<HTML xmlns:="http://www.w3.org/1999/xhtml">
  <HEAD>
	...
	function onLoadDo()
	{
		this.windowTables = new Array(new windowTableId('client', 'buttonOK'));setWindowTableParentElement();enableShortcuts('popup');setBrowserAutoComplete(false);onResizeDo();
