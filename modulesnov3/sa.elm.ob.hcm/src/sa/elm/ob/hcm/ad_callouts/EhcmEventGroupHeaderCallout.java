...
public class EhcmEventGroupHeaderCallout extends SimpleCallout {

  /**
   * Callout to update the "End Date" by session date if we uncheck the enabled flag in "Event
   * Group" Window header
   */
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    try {
      ...
      log4j.error("Exception in Event Group Action Type active Callout :", e);
