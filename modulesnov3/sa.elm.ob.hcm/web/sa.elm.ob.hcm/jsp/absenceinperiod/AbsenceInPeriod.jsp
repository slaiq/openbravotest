...
<HEAD>
<TITLE><%= Resource.getProperty("hcm.absenceinperiod.title",lang) %></TITLE>
                              ...
                              <div>
                                 <span class="dojoTabcurrentfirst">
                                    <div>
                                       ...
                                       <%= Resource.getProperty("hcm.absenceinperiod.title",lang).replace("'", "\\\'") %>
                                       </a></span>
                                    </div>
                                 </span>
                              </div>
...
function reloadWindow() {
    submitCommandForm('DEFAULT', false, null, 'AbsenceInPeriod', '_self', null, false);
    return false;
}
...
function generateReport() {
    ...
    if(valid==1){
        openServletNewWindow('PRINT_PDF', true, null, 'AbsenceInPeriod', null, false, '700', '1000', true);
        return false;
    }
}
