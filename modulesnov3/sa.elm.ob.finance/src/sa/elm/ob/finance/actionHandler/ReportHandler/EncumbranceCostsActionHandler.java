...
public class EncumbranceCostsActionHandler extends ProcessReportActionHandler {
  private static final Logger log4j = LoggerFactory.getLogger(EncumbranceCostsActionHandler.class);
