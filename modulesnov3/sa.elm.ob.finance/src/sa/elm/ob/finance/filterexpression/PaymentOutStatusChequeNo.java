...
/**
 * 
 * This class is to apply Saved Cheque No from Payment Out screen
 * 
 * @author Mouli.K
 */
public class PaymentOutStatusChequeNo implements FilterExpression {
  ...
  public String getExpression(Map<String, String> _requestMap) {
    ...
    try {
      ...
      if (objPO != null) {
        return objPO.getEfinMofchequeno();
      } else {
        return "";
      }
