...
public class EfinUniqueCodeFilterByDepartment implements FilterExpression {
  private Map<String, String> requestMap;
  private final static Logger log4j = Logger.getLogger(EfinUniqueCodeFilterByDepartment.class);

  /**
   * This class is used to filter unique code by department
   */
  @Override
  public String getExpression(Map<String, String> _requestMap) {
    try {
      ...
      if (objBC != null) {
        return objBC.getBudgetcontrolunit().getId();
      } else {
        return "";
      }
    } catch (Exception e) {
      log4j.error("Exception in EfinUniqueCodeFilterByDepartment : " + e);
      return "";
    }
  }
}
