...
/**
 * 
 * This class is to apply Saved Bank Name from Payment Out screen
 * 
 * @author Mouli.K
 */
public class PaymentOutStatusBankName implements FilterExpression {
  ...
  public String getExpression(Map<String, String> _requestMap) {
    ...
    try {
      ...
      if (objPO != null && StringUtils.isNotEmpty(objPO.getEfinMofbankname())) {
        return objPO.getEfinMofbankname();
      } else if (objPO.getEFINBank() != null) {
        return objPO.getEFINBank().getBankname();
      } else {
        return "";
      }
