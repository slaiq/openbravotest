 ...
 *
 */
public class RdvHoldAction extends HttpSecureAppServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (inpAction.equals("")) {
      ...
      // combinationObject.has("PenCode") ? combinationObject.getString("PenaltyCode")
      // : null);
