...
public class Reconciliation extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strValidBank = vars.getStringParameter("inpValidBank");
      ...
      printGrid(response, strFinancialAccountId, strStatementDate, strAfterDate,
          ...
          strSortColumn, strSortType, strValidBank);
    ...
    try {
      ...
      if (process) { // Validations
        ...
        while (rs.next()) {
          ...
          line.setWithdrawalAmount(new BigDecimal(rs.getInt("paymentamt")));
          line.setDepositAmount(new BigDecimal(rs.getInt("depositamt")));
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strOrgId,
    ...
    try {
      ...
      XmlDocument xmlDocument = xmlEngine
          .readXmlTemplate("sa/elm/ob/finance/ad_actionbutton/NonMOFReconcile/Reconciliation")
          .createXmlDocument();
  ...
  private void printGrid(HttpServletResponse response, String strFinancialAccountId,
      ...
      String sortType, String strValidBank) throws IOException, ServletException {

    log4j.debug("Output: Grid on Financial Account || Transaction tab || Reconciliation window");

    XmlDocument xmlDocument = xmlEngine
        .readXmlTemplate("sa/elm/ob/finance/ad_actionbutton/NonMOFReconcile/ReconciliationGrid")
        .createXmlDocument();
    ...
    FieldProvider[] data = TransactionsDao.getTransactionsFiltered(account,
        ...
        sortColumn, sortType, strValidBank);
