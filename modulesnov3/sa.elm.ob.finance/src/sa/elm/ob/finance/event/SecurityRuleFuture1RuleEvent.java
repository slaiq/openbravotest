...
public class SecurityRuleFuture1RuleEvent extends EntityPersistenceEventObserver {

  private static Entity[] entities = {
      ModelProvider.getInstance().getEntity(EfinSecurityRulesFutureOne.ENTITY_NAME) };
  ...
  public void onSave(@Observes EntityNewEvent event) {
    ...
    try {
      EfinSecurityRulesFutureOne accounts = (EfinSecurityRulesFutureOne) event.getTargetInstance();
      String fromFuture1 = accounts.getFromfuture1().getSearchKey();
      String toFuture1 = accounts.getTofuture1().getSearchKey();
      int fromtoFuture1 = fromFuture1.compareTo(toFuture1);
      if (fromtoFuture1 > 0) {
      ...
      log.debug("Exception on save Event in SecurityRuleFuture1RuleTypeRuleTabEvent ", e);
    }
  ...
  public void onUpdate(@Observes EntityUpdateEvent event) {
    ...
    try {
      ...
      log.debug("Exception on update Event in SecurityRuleFuture1RuleTypeRuleTabEvent ", e);
    }
  }
  ...
  public void onDelete(@Observes EntityDeleteEvent event) {
    ...
    try {
      ...
      log.debug("Exception in Delete Event in SecurityRuleFuture1RuleTypeRuleTabEvent ", e);
    }
