         ...
         <INPUT type="hidden" name="inppenaltytype" id="inppenaltytype" value="<%= request.getAttribute("inppenaltytype") %>"></INPUT> 
          ...
          <INPUT type="hidden" name="inpinvoiceNo" id="inpinvoiceNo" value=""></INPUT>  
           ...
           <INPUT type="hidden" name="inprdvtrxtype" id="inprdvtrxtype" value="<%= request.getAttribute("inprdvtrxtype") %>"></INPUT>
                     ...
                     <INPUT type="hidden" name="inpselectedRecordsId" id="inpselectedRecordsId" value="<%= request.getAttribute("inpselectedRecordsId") %>"></INPUT>
     ...
     <table cellspacing="0" cellpadding="0" class="Popup_ContentPane_InfoBar">
        <tbody><tr>
          ...
          <td class="Popup_InfoBar_text_table">
            <table>
              <tbody><tr>
                <td class="Popup_InfoBar_text" id="processHelp"><%=Resource.getProperty("finance.bulk.penalty.action",lang)%> </td>
              </tr>
            </tbody></table>
          </td>
        </tr>
...
var alllinepenalty='<%= Resource.getProperty("finance.bulk.penalty.allline", lang) %>';
var distribute='<%= Resource.getProperty("finance.bulk.penalty.distribute", lang) %>';
var bulkpenaltyamountlogic='<%= Resource.getProperty("finance.bulk.penalty.type", lang) %>';
var bulkpenaltyAmtGreater='<%= Resource.getProperty("finance.bulk.penalty.penatyamtgreater", lang) %>';
var bulkpenaltysuccess='<%= Resource.getProperty("finance.bulk.penalty.success", lang) %>';
...
<script type="text/javascript" src="../web/sa.elm.ob.finance/js/PenaltyAction/bulkpenaltyactionrdv.js"></script>
