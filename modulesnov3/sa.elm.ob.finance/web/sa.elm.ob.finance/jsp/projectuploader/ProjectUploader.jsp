    ...
    function uploadProject()
    {
        ...
        if (filename == '') 
        {
            ...
            if (extension == "xls" || extension == "xlsx") {
                ...
                document.frmMain.action = '<%=request.getContextPath()%>/sa.elm.ob.finance.ad_process.projectuploader.header/ProjectUploader?inpAction=UploadProject';
    ...
    <TD>
      <TABLE cellspacing="0" cellpadding="0" class="Popup_ContentPane_NavBar" id="tdToolBar">
        <TR class="Popup_NavBar_bg"><TD></TD>
          ...
          <TD class="Popup_NavBar_Popup_title_cell"><SPAN><%=Resource.getProperty("finance.paymentout.uploadproject",lang)%></SPAN></TD>
          <TD class="Popup_NavBar_separator_cell"></TD>
        </TR>
      </TABLE>
    </TD>
     ...
     <table cellspacing="0" cellpadding="0" class="Popup_ContentPane_InfoBar">
        <tbody><tr>
          ...
          <td class="Popup_InfoBar_text_table">
            <table>
              <tbody><tr>
                <td class="Popup_InfoBar_text" id="processHelp"><%=Resource.getProperty("finance.paymentout.uploadproject",lang)%> </td>
              </tr>
            </tbody></table>
          </td>
        </tr>
          ...
          <TABLE cellspacing="0" cellpadding="0" class="Popup_Client_TablePopup">           
            ...
            <td>
                <table width="100%" border="0" style="margin:0px;padding-top: 20px" >
                    <tr style="width: 100%">
                        <TD class="TitleCell" ><span><%=Resource.getProperty("finance.paymentout.uploadproject",lang)%></SPAN></TD>
...
<script type="text/javascript" src="../web/js/jquery-1.7.2.min.js"></script>
    ...
    <script type="text/javascript">
    function closePopUp() {
        document.frmMain.action="<%=request.getContextPath()%>/sa.elm.ob.finance.ad_process.projectuploader.header/ProjectUploader?inpAction=Close&pageType="+"<%= request.getAttribute("pageType") %>";
        document.frmMain.submit();
    }
</script>
</HTML>
