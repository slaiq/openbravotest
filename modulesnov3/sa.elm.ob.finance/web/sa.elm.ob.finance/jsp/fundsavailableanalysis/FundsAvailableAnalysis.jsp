...
<HEAD>
<TITLE><%= Resource.getProperty("finance.fundsavailableanalysis.title",lang) %></TITLE>
                              ...
                              <div>
                                 <span class="dojoTabcurrentfirst">
                                    <div>
                                       ...
                                       <%= Resource.getProperty("finance.fundsavailableanalysis.title",lang).replace("'", "\\\'") %>
                                       </a></span>
                                    </div>
                                 </span>
                              </div>
                                       ...
                                       <TABLE  align="center" width="100%">
                                          ...
                                          <tr>
                                             ...
                                             <td class="TextBox_ContentCell">
                                                <select id="inpBudgetYearId" class="ComboKey Combo_TwoCells_width">
                                                   <%   if(budYrs.length() > 0){
...
function reloadWindow() {
    submitCommandForm('DEFAULT', false, null, 'FundsAvailableAnalysis', '_self', null, false);
    return false;
}
...
function generateReport() {
    ...
    openServletNewWindow('PRINT_PDF', true, null, 'FundsAvailableAnalysis', null, false, '700', '1000', true);
    return false;
}
...
$( "#inpBudgetItemFrom").select2(selectBoxAjaxPaging({size: "small", placeholder: true}));
$( "#inpBudgetItemTo").select2(selectBoxAjaxPaging({size: "small", placeholder: true}));
   </script>
</HTML>