...
<HTML xmlns="http://www.w3.org/1999/xhtml">
    ...
    <TITLE><%= Resource.getProperty("finance.paymentreport.title",lang) %></TITLE>
    ...
    <BODY onresize="onResizeDo();" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" id="paramBody">
        <FORM id="form" method="post" action="" name="frmMain">
            ...
            <INPUT type="hidden" name="inpfinPaymentId" id="inpfinPaymentId" value="${requestScope.inpfinPaymentId}"></INPUT>
            <INPUT type="hidden" name="inpClientId" id="inpClientId" value="${requestScope.inpClientId}"></INPUT>
            <INPUT type="hidden" name="inpOrgId" id="inpOrgId" value="${requestScope.inpOrgId}"></INPUT>
                                        ...
                                        <div>
                                            <span class="dojoTabcurrentfirst">
                                                <div>
                                                    ...
                                                    <%= Resource.getProperty("finance.paymentreport.title",lang) %>
                                                    </a></span>
                                                </div>
                                            </span>
                                        </div>
                                                ...
                                                <TD>
                                                    ...
                                                    <TABLE  align="center" width="100%">
                                                        ...
                                                        <TD class="TitleCell" >
                                                                ...
                                                                <%= Resource.getProperty("finance.glreport.field.label",lang) %>
                                                                    ...
                                                                    <BUTTON type="button" id="Submit_linkBTN" class="ButtonLink" onclick="generateReport();" style="margin: 10px 0;">
                                                                        <TABLE class="Button">
                                                                            <TR>
                                                                                ...
                                                                                <%= Resource.getProperty("finance.glreport.button.generatereport",lang) %>
                                                                                </TD>
    ...
    {
        submitCommandForm('DEFAULT', false, null, 'PaymentReport', '_self', null, false); 
        return false;
    }
    ...
    function generateReport() 
    {
        ...
        openServletNewWindow('DEFAULT', true,null, 'PaymentReport', null, false, '700', '1000', true);
        return false;
        /* if(document.getElementById("formattype").value=='xls')
        {
            openServletNewWindow('PRINT_XLS', true,null, 'PaymentReport', null, false, '700', '1000', true);
            return false;
        }
        else
        {
            openServletNewWindow('PRINT_PDF', true,null, 'PaymentReport', null, false, '700', '1000', true);
            return false;
        } */
        /* PrintPagepopdownload('DEFAULT', false, null, 'PaymentReport', '_self', null, false); 
         */
         setTimeout(function(){  closePage(); }, 1000);
         return true;
    }
    </script>
