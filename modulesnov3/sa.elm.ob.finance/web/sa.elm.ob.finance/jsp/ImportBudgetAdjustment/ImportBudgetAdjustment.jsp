...
<FORM name="frmMain" method="post" action="" enctype="multipart/form-data" id="SubContractForm">
  ...
  <INPUT type="hidden" name="inpFormID" id="inpFormID" value="<%=request.getAttribute("inpFormID")%>"></INPUT>
   <INPUT type="hidden" name="inpBudgetAdjID" id="inpBudgetAdjID" value="<%= request.getAttribute("inpBudgetAdjID")%>"></INPUT>
...
function validateFile() {
    ...
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.finance.ad_process.ImportBudgetAdjustment.header/ImportBudgetAdjustment?action=validateCsv&inpBudgetAdjID="+document.getElementById('inpBudgetAdjID').value;
...
function uploadCSV() {
    ...
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.finance.ad_process.ImportBudgetAdjustment.header/ImportBudgetAdjustment?action=uploadCsv&inpBudgetAdjID="+document.getElementById('inpBudgetAdjID').value;
    document.forms['frmMain'].submit();
    
}
function closePopUp() {
    document.frmMain.action="<%=request.getContextPath()%>/sa.elm.ob.finance.ad_process.ImportBudgetAdjustment.header/ImportBudgetAdjustment?action=Close&pageType="+"<%= request.getAttribute("pageType") %>";
