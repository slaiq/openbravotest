                                       ...
                                       <TABLE  align="center" width="70%">
                                          ...
                                          <tr id="inpLoanScsbRow" style="display:none;">
                                             <td class="TitleCell"><span class="LabelText" id="inpLoanNoLabel"> <b> <%=Resource.getProperty("finance.fd.loanNumber", lang).replace("'", "\\\'")%>
                                              ...
                                              <td class="TextBox_ContentCell">
                                                <input type="text" name="inpLoan" id="inpLoanNo" maxlength="30"  class="dojoValidateValid TextBox_TwoCells_width" onkeydown="return true;" onkeyup="enableForm(this);" />
                                              </td>
                                          </tr>
                                           <tr id="inpContractAgriRow" style="display:none;">
                                             <td class="TitleCell"><span class="LabelText" id="inpContractNoLabel"> <b> <%=Resource.getProperty("finance.fd.contractNumber", lang).replace("'", "\\\'")%>
                                              ...
                                              <td class="TextBox_ContentCell">
                                                <input type="text" name="inpContractNo" id="inpContractNo" maxlength="30"  class="dojoValidateValid TextBox_TwoCells_width" onkeydown="return true;" onkeyup="enableForm(this);" />
                                              </td>
                                          </tr>
                                          ...
                                          <tr id="inpLoanAmountRow">
                                             ...
                                             <td class="TextBox_ContentCell">
                                               <input type="text" name="inpLoanAmount" id="inpLoanAmountId" maxlength="30"  class="dojoValidateValid TextBox_TwoCells_width"  readonly onkeydown="return true;" onkeyup="enableForm(this);" />
                                             </td>
                                          </tr>
...
function fillLoanDetails(){
    ...
    $.post('<%=request.getContextPath()%>/FundDeptEnquiryAjax', {
        ...
        inpLoanNo : document.getElementById("inpLoanNo").value,
        inpContractNo : document.getElementById("inpContractNo").value 
