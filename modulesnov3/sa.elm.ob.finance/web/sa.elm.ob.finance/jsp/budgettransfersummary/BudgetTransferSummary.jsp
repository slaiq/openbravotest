...
<HEAD>
<TITLE><%= Resource.getProperty("finance.budgettransfersumm.title.title",lang) %></TITLE>
                              ...
                              <div>
                                 <span class="dojoTabcurrentfirst">
                                    <div>
                                       ...
                                       <%= Resource.getProperty("finance.budgettransfersumm.title",lang).replace("'", "\\\'") %>
                                       </a></span>
                                    </div>
                                 </span>
                              </div>
                                 ...
                                 <TR>
                                    <TD>
                                       ...
                                       <TABLE  align="center" width="100%">
                                          ...
                                          <tr>
                                             <td class="TitleCell"><span class="LabelText" id="inpBudgetRevIdLabel"> <b> <%=Resource.getProperty("finance.budgettransfersumm.budgettransno", lang).replace("'", "\\\'")%>
                                                </b>
                                                </span>
                                             </td>
                                             <td class="TextBox_ContentCell">
...
function reloadWindow() {
    submitCommandForm('DEFAULT', false, null, 'BudgetTransferSummary', '_self', null, false);
    return false;
}
...
function generateReport() {
    ...
    openServletNewWindow('PRINT_PDF', true, null, 'BudgetTransferSummary', null, false, '700', '1000', true);
    return false;
}
...
function getBudgetRevisions(yearId){
    document.getElementById("inpBudgetRevId").value = "0";
        $("#inpBudgetRevId").select2(selectBoxAjaxPaging({
            url : function() {
                return '<%=request.getContextPath()%>/BudgetRevisionSummaryAjax?action=getBudgetRevisions&yearId='+yearId+'&transacType=TRS'
           },
