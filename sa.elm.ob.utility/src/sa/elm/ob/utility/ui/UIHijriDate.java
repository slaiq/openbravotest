...
public class UIHijriDate extends UIReference {
	public UIHijriDate(String reference, String subreference) {
		super(reference, subreference);
		addSecondaryFilter = true;
	}

	public void generateFilterHtml(StringBuffer strHtml, VariablesSecureApp vars, BuscadorData fields, String strTab, String strWindow, ArrayList<String> vecScript, Vector<Object> vecKeys) throws IOException, ServletException {
		UIReferenceUtility.addUniqueElement(vecScript, strReplaceWith + "/js/jscalendar/calendar.js");
		UIReferenceUtility.addUniqueElement(vecScript, strReplaceWith + "/js/jscalendar/lang/calendar-" + vars.getLanguage().substring(0, 2) + ".js\"");
		...
		strHtml.append("<script>djConfig.searchIds.push(\"").append("inpParam").append(FormatUtilities.replace(fields.columnname)).append("\") </script>");
		strHtml.append("</td>\n");
		strHtml.append("<td class=\"FieldButton_ContentCell\">");
		strHtml.append("<a href=\"#\" class=\"FieldButtonLink\" onclick=\"showCalendar('frmMain.inpParam").append(FormatUtilities.replace(fields.columnname)).append("', ");
		strHtml.append("document.frmMain.inpParam").append(FormatUtilities.replace(fields.columnname)).append(".value, false, '").append(vars.getSessionValue("#AD_SqlDateFormat")).append("');");
		...
		// "To" box
		String value = vars.getSessionValue(strTab + "|param" + FormatUtilities.replace(fields.columnname) + "_f");
		...
		strHtml.append("displayFormat=\"").append(vars.getSessionValue("#AD_SqlDateFormat")).append("\" ");
		strHtml.append("saveFormat=\"").append(vars.getSessionValue("#AD_SqlDateFormat")).append("\" ");
		strHtml.append("name=\"inpParam").append(FormatUtilities.replace(fields.columnname)).append("_f\" ");
		strHtml.append("maxlength=\"").append(vars.getSessionValue("#AD_SqlDateFormat").length()).append("\" ");
		strHtml.append("value=\"").append(value).append("\" ");
		strHtml.append("id=\"inpParam").append(FormatUtilities.replace(fields.columnname)).append("_f\" ");
		strHtml.append("onkeyup=\"autoCompleteDate(this.textbox);\"></input> ");
		strHtml.append("<script>djConfig.searchIds.push(\"").append("inpParam").append(FormatUtilities.replace(fields.columnname)).append("_f\") </script>");
		strHtml.append("</td>\n");
		strHtml.append("<td class=\"FieldButton_ContentCell\">");
		strHtml.append("<a href=\"#\" class=\"FieldButtonLink\" onclick=\"showCalendar('frmMain.inpParam").append(FormatUtilities.replace(fields.columnname)).append("_f', ");
		strHtml.append("document.frmMain.inpParam").append(FormatUtilities.replace(fields.columnname)).append("_f.value, false, '").append(vars.getSessionValue("#AD_SqlDateFormat")).append("');");
		strHtml.append("return false;\" onfocus=\"setWindowElementFocus(this); window.status='Calendar'; return true;\" onblur=\"window.status=''; return true;\" onkeypress=\"this.className='FieldButtonLink_active'; return true;\" onkeyup=\"this.className='FieldButtonLink_focus'; return true;\">\n");
		strHtml.append("<table class=\"FieldButton\" onmouseout=\"this.className='FieldButton';window.status='';return true;\" onmouseover=\"this.className='FieldButton_hover';window.status='Show calendar';return true;\" onmousedown=\"this.className='FieldButton_active';return true;\" onmouseup=\"this.className='FieldButton';return true;\">\n");
		strHtml.append("<tr>\n");
		strHtml.append("<td class=\"FieldButton_bg\">");
