...
<HTML xmlns="http://www.w3.org/1999/xhtml">
  <HEAD>
   <META http-equiv="Content-Type" content="text/html; charset=utf-8"></META> 
	...
	function onLoadDo(){this.windowTables = new Array(new windowTableId('client', 'buttonOK'));setWindowTableParentElement();this.tabsTables = new Array(new tabTableId('tdtopTabs'));setTabTableParentElement();setBrowserAutoComplete(false);setFocusFirstControl(null, 'inpMailTemplate');resizeArea();updateMenuIcon('buttonMenu');
	ErrorMessage("");
	}
	function ErrorMessage(message)
	{
		...
		document.getElementById("messageBoxIDMessage").innerHTML="<%=Resource.getProperty("utility.nodocumentseq.msg",lang)%>";
