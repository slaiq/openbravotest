...
public class OBViewGridComponent extends BaseTemplateComponent {
  ...
  private String addTransactionalFilter(String filterClause) {
    ...
    if (tab.getId().equals("800249") || tab.getId().equals("290")
        || tab.getId().equals("7185D00B421A4F62B403E085F00176D6")
        || tab.getId().equals("F7A52FDAAA0346EFA07D53C125B40404")
        || tab.getId().equals("C4B6506838E14A349D6717D6856F1B56") || tab.getId().equals("296")) {
      return "";
    } else {
