...
public class JsonToDataConverter {
  ...
  private final static SimpleDateFormat customFormat = new SimpleDateFormat("dd-MM-yyyy");

  private final List<JsonConversionError> errors = new ArrayList<JsonConversionError>();

  public static List<String> unRealDateList = Arrays.asList("29-02-1430", "30-02-1430",
      "30-02-1431", "29-02-1431", "30-02-1432", "29-02-1433", "29-02-1434", "30-02-1434",
      "29-02-1435", "30-02-1436", "29-02-1437", "29-02-1438", "29-02-1439", "30-02-1440",
      "29-02-1441", "29-02-1442", "30-02-1442", "29-02-1443", "30-02-1444", "29-02-1445",
      "30-02-1445", "29-02-1446", "30-02-1446", "29-02-1447", "30-02-1448");
      ...
      if (clz != null && Date.class.isAssignableFrom(clz)) {
        try {
          ...
          if (property.getDomainType() instanceof TimestampDomainType) {
            ...
            if (unRealDateList.contains((String) value)) {
              String dateArray[] = value.toString().split("-");
              return UtilityDAO.convertToGregorianDate(dateArray[2] + dateArray[1] + dateArray[0]);
            } else {
    ...
    for (String keyName : keyNames) {
      ...
      if (multiPathProperty) {
        ...
        if (property.getDomainType() instanceof EncryptedStringDomainType
            || property.getDomainType() instanceof HashedStringDomainType || property
