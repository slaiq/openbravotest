...
public class LinkToParentTreeDatasourceService extends TreeDatasourceService {
  ...
  protected JSONArray fetchNodeChildren(Map<String, String> parameters,
    ...
    hasLineNo = Utility.checkTableHasLineNo(table.getId());
    // If table column has line Number it will sort ascending
    if (hasLineNo)
      orderByClause = whereClause.append(" order by e.lineNo asc");
    else
      orderByClause = whereClause.append("");
