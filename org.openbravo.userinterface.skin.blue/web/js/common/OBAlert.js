...
function addMessage(message, title, type, button, image, callback) {
	...
	if (navigator.appName.toLowerCase().indexOf("microsoft") != -1)
		pad = '4';
	var html = '<table id="Dialog_HeaderMovable" cellspacing="0" cellpadding="2" style="-moz-border-image: none; width: 100%; border: 2px solid #eb7f00; border-top: 0px;">'
			+ '<tbody><tr style="background-color: #eb7f00;  width: 100%; height: 27px;">'
			+ '<td align="left" valign="middle" style="width: 20px;"><div style="margin-left: 4px; margin-top: 2px;"><img alt="Openbravo" src="../web/org.openbravo.userinterface.smartclient/openbravo/skins/Default/smartclient/images/Dialog/DialogHeaderIcon.png"></div></td>'
			...
			+ '<img id="Dialog_Close" alt="Close" src="../web/org.openbravo.userinterface.smartclient/openbravo/skins/Blue/org.openbravo.client.application/images/popup/close.png" style="cursor: pointer;" onclick="" ></div></td>' + '</tr></tbody></table>';
	// Set Message Info
	html += '<table id="Dialog_Body" cellspacing="0" cellpadding="2" style="width: 100%; height: 123px; border: 2px solid #eb7f00; border-top: 0px;">'
			+ '<tr><td style="vertical-align: top;"><div style="margin-left: 20px; margin-top: 20px;">';
	if (image == "W")
		html += '<img alt="B" src="../web/org.openbravo.userinterface.smartclient/openbravo/skins/Default/smartclient/images/Dialog/confirm.png"></img>';
	if (image == "I")
		html += '<img alt="B" src="../web/org.openbravo.userinterface.smartclient/openbravo/skins/Default/smartclient/images/Dialog/confirm.png"></img>';
	if (image == "C")
		html += '<img alt="B" src="../web/org.openbravo.userinterface.smartclient/openbravo/skins/Default/smartclient/images/Dialog/confirm.png"></img>';
	...
	if (button == "O")
		html += '<td><input type="button" id="Dialog_OK" style="float: left; border: 2px solid #eb7f00;color: #fff;cursor: pointer;font-family: \'lucida sans\',sans-serif; font-size: 12px;padding: 4px 20px; background-color: #eb7f00;" value="OK"></input></td>';
	else if (button == "OC") {
		html += '<td><input type="button" id="Dialog_OK"     style="float: left; border: 2px solid #eb7f00;color: #fff;cursor: pointer;font-family: \'lucida sans\',sans-serif; font-size: 12px;padding: 4px 20px; background-color: #eb7f00;" value="OK"></input></td>';
		html += '<td><input type="button" id="Dialog_CANCEl" style="float: left; border: 2px solid #eb7f00;color: #fff;cursor: pointer;font-family: \'lucida sans\',sans-serif; font-size: 12px;padding: 4px 20px; background-color: #eb7f00;" value="Cancel"></input></td>';
	}
	else if (button == "YN") {
		html += '<td><input type="button" id="Dialog_OK"     style="float: left; border: 2px solid #eb7f00;color: #fff;cursor: pointer;font-family: \'lucida sans\',sans-serif; font-size: 12px;padding: 4px 20px; background-color: #eb7f00;" value="Yes"></input></td>';
		html += '<td><input type="button" id="Dialog_CANCEl" style="float: left; border: 2px solid #eb7f00;color: #fff;cursor: pointer;font-family: \'lucida sans\',sans-serif; font-size: 12px;padding: 4px 20px; background-color: #eb7f00;" value="No"></input></td>';
	}
	...
	overlayDiv.onclick = function(e) {
		if (cancelButton != undefined && cancelButton.style.borderColor == "rgb(250, 150, 47)") {
			cancelButton.style.border = "2px solid #eb7f00";
			okButton.style.border = "2px solid #eb7f00";
			cancelButton.focus();
		}
		else {
			okButton.style.border = "2px solid #eb7f00";
