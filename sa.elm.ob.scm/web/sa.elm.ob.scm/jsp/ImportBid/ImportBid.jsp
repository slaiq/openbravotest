...
<HEAD>
 <META http-equiv="Content-Type" content="text/html; charset=utf-8"></META>
    <TITLE><%=Resource.getProperty("scm.import.bid.title",lang)%></TITLE>
...
<FORM name="frmMain" method="post" action="" enctype="multipart/form-data" id="SubContractForm">
  ...
  <INPUT type="hidden" name="inpBidmgmtId" id="inpBidmgmtId" value="<%= request.getAttribute("inpBidmgmtId")%>"></INPUT>
    ...
    <TD>
      <TABLE cellspacing="0" cellpadding="0" class="Popup_ContentPane_NavBar" id="tdToolBar">
        <TR class="Popup_NavBar_bg"><TD></TD>
          ...
          <TD class="Popup_NavBar_Popup_title_cell"><SPAN><%=Resource.getProperty("scm.import.bid.title",lang)%></SPAN></TD>
          <TD class="Popup_NavBar_separator_cell"></TD>
        </TR>
      </TABLE>
    </TD>
     ...
     <table cellspacing="0" cellpadding="0" class="Popup_ContentPane_InfoBar">
        <tbody><tr>
          ...
          <td class="Popup_InfoBar_text_table">
            <table>
              <tbody><tr>
                <td class="Popup_InfoBar_text" id="processHelp"><%=Resource.getProperty("scm.import.bid.title",lang)%> </td>
              </tr>
            </tbody></table>
          </td>
        </tr>
...
function validateFile() {
    ...
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.scm.ad_process.BidManagement.ImportBid/ImportBidLines?action=validateCsv&inpBidmgmtId="+document.getElementById('inpBidmgmtId').value;
...
function uploadCSV() {
    ...
    document.forms['frmMain'].action= "<%=request.getContextPath() %>/sa.elm.ob.scm.ad_process.BidManagement.ImportBid/ImportBidLines?action=uploadCsv&inpBidmgmtId="+document.getElementById('inpBidmgmtId').value;
    document.forms['frmMain'].submit();
    
}

function closePopUp() {
    document.frmMain.action="<%=request.getContextPath()%>/sa.elm.ob.scm.ad_process.BidManagement.ImportBid/ImportBidLines?action=Close&pageType="+"<%= request.getAttribute("pageType") %>";
