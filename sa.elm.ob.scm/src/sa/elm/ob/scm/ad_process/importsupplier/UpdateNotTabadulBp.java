...
public class UpdateNotTabadulBp extends DalBaseProcess {

  /**
   * This Process Class is responsible to update Non tabadul Business Partner records
   */
  ...
  public void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      String qry = "select em_efin_documentno "
          + " from c_bpartner where em_escm_tabadulid is null and length(em_efin_documentno)=10 "
