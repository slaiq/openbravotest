package sa.elm.ob.scm.ad_forms.CustodyUpload.header;
...
import sa.elm.ob.scm.ad_forms.CustodyUpload.dao.CustodyUploadTemplateDAO;

/**
 * @author Gopalakrishnan on 27/04/2017
 */
public class CustodyUploadTemplate extends HttpSecureAppServlet {

  /**
   * Servlet implementation class Custody Upload Template
   */
  ...
  private static final String includeIn = "../web/sa.elm.ob.scm/jsp/CustodyUpload/CustodyUpload.jsp";

  /**
   * @see HttpServlet#HttpServlet()
   */
  public CustodyUploadTemplate() {
    super();
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (inpAction.equals("uploadCsv") || inpAction.equals("validateCsv")) {
      ...
      CustodyUploadTemplateDAO dao = null;
      ...
      try {
        ...
        dao = new CustodyUploadTemplateDAO();
